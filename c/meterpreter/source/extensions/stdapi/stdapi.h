...
// arbitrary quality is not implemented yet
#define TLV_TYPE_DXDESKTOP_SCREENSHOT                 MAKE_CUSTOM_TLV( TLV_META_TYPE_RAW,     TLV_TYPE_EXTENSION_STDAPI, 3020 )
#define TLV_TYPE_DXDESKTOP_SCREENSHOT_PE32DLL_LENGTH  MAKE_CUSTOM_TLV( TLV_META_TYPE_UINT,    TLV_TYPE_EXTENSION_STDAPI, 3021 )
#define TLV_TYPE_DXDESKTOP_SCREENSHOT_PE32DLL_BUFFER  MAKE_CUSTOM_TLV( TLV_META_TYPE_STRING,  TLV_TYPE_EXTENSION_STDAPI, 3022 )
#define TLV_TYPE_DXDESKTOP_SCREENSHOT_PE64DLL_LENGTH  MAKE_CUSTOM_TLV( TLV_META_TYPE_UINT,    TLV_TYPE_EXTENSION_STDAPI, 3023 )
#define TLV_TYPE_DXDESKTOP_SCREENSHOT_PE64DLL_BUFFER  MAKE_CUSTOM_TLV( TLV_META_TYPE_STRING,  TLV_TYPE_EXTENSION_STDAPI, 3024 )
